...
- (instancetype)init{
    self = [super initWithFrame:CGRectMake(HCScreenWidth/2-kColorPickWindowSize/2, HCScreenHeight/2-kColorPickWindowSize/2, kColorPickWindowSize, kColorPickWindowSize)];
    if (self) {
